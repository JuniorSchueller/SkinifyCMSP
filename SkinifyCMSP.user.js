                ...
                if (skinData.allowCheats || skinData.allowCheats === 'true') {
                    if (document.querySelector('#root > div:nth-child(2)').innerHTML.includes('<div class="cheatsWarning">')) {} else {
                        ...
                        document.querySelector('#activateCheat').addEventListener('click', () => {
                            ...
                            document.querySelector('.cheatsWarning').innerHTML = '<p>Cheats ativado!</p>'
                        });
                    }
                }
            } else {
